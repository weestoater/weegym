function Programme() {
  const programmeData = {
    ...
    day1: {
      ...
      exercises: [
        { name: 'Chest Press', type: 'Machine', sets: 3, reps: '10-12', rest: '90s' },
        { name: 'Lat Pulldown', type: 'Machine', sets: 3, reps: '10-12', rest: '90s' },
        { name: 'Shoulder Press', type: 'Machine', sets: 3, reps: '10-12', rest: '90s' },
        { name: 'Bicep Curls', type: 'Free-weights', sets: 3, reps: '10-12', rest: '60s' },
        { name: 'Tricep Extensions', type: 'Free-weights', sets: 3, reps: '10-12', rest: '60s' },
      ]
    },
    day2: {
      name: 'Day 2 - Lower Body',
      exercises: [
        { name: 'Leg Press', type: 'Machine', sets: 3, reps: '10-12', rest: '120s' },
        { name: 'Leg Curl', type: 'Machine', sets: 3, reps: '10-12', rest: '90s' },
        { name: 'Leg Extension', type: 'Machine', sets: 3, reps: '10-12', rest: '90s' },
        { name: 'Calf Raises', type: 'Machine', sets: 3, reps: '12-15', rest: '60s' },
        { name: 'Plank', type: 'Free-weights', sets: 3, reps: '30-60s', rest: '60s' },
      ]
    }
  }
      ...
      <div className="card mb-4">
        ...
        <div className="card-body">
          ...
          <p className="small mb-3">
            Gradually increase intensity over time. Once you hit the top of the rep range, increase the weight slightly.
          </p>
          <h4 className="h6 fw-bold">Time Under Tension</h4>
          <p className="small mb-0">
            Maintain control: 2 seconds up (concentric), 2 seconds down (eccentric). This maximizes muscle growth.
          </p>
        </div>
      </div>
            ...
            <div key={index} className="list-group-item">
              <div className="d-flex justify-content-between align-items-start">
                <div>
                  ...
                  <span className="badge bg-secondary small">{exercise.type}</span>
                </div>
