...
function Settings() {
  ...
  // Initialize settings from Supabase or localStorage fallback
      ...
      {loading ? (
        ...
        <>
          <div className="card mb-4">
            ...
            <div className="card-body">
              <p className="text-muted small mb-3">
                Configure default rest times between sets. You can always skip
                or adjust during your workout.
              </p>
                ...
                <div className="input-group">
                  <button
                    ...
                    onClick={() =>
                      setSettings({
                        ...settings,
                        shortRestTime: Math.max(
                          30,
                          settings.shortRestTime - 15,
                        ),
                      })
                    }
          ...
          <div className="alert alert-info" role="alert">
            ...
            <strong>Note:</strong> These rest times will be used as defaults in
            your workouts. You can always skip the rest timer during your
            session.
          </div>
        </>
      )}
